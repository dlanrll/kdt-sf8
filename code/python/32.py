...
# 추상 클래스 정의
class PaymentSystem(ABC):  # P.S 클래스는 ABC 를 상속받는 추상 클래스
    # 추상 메서드 2개 정의
    ...
    # 일반 메서드
    def payment_info(self, amount):  # 결제 완료 후 정보 출력
...
print(f"할인후 결제액: {pay_after_discount}")
'''